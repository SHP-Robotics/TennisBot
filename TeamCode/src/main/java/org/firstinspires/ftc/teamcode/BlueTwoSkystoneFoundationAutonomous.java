...
public class BlueTwoSkystoneFoundationAutonomous extends BaseRobot {
    private int stage = 0;
    ...
    private static float offsetX = -1.7f/8f;//changing this moves the three rects and the three circles left or right, range : (-2, 2) not inclusive
...
//                break;
            ...
            case 1:
                if (position == 0) {
                    if (auto_mecanum(1, 23)) {
                        reset_drive_encoders();
                        stage++;
                    }
                } else if (position == 1) {
                    if (auto_mecanum(1, 17)) {
                        reset_drive_encoders();
                        stage++;
                    }
                } else if (position == 2) {
            ...
            case 3:
                ...
                if (position == 0) {
                    if (auto_drive_imu(0.4,28,-25,angles.firstAngle)) {
                        intakeOut(0);
                        reset_drive_encoders();
                        stage++;
                    }
            ...
            case 4:
                ...
                if (position == 0) {
                    if (auto_drive_imu(-1,17, -25, angles.firstAngle)) {
                        reset_drive_encoders();
                        stage++;
                    }
                } else {
            ...
            case 6:
                ...
                if (position == 0) {
                    if (auto_drive_imu(-1, 156,-85,angles.firstAngle)) {
                        reset_drive_encoders();
                        stage++;
                    }
                } else if (position == 1) {
                    if (auto_drive_imu(-1, 147,-85,angles.firstAngle)) {
                        reset_drive_encoders();
                        stage++;
                    }
                } else if (position == 2) {
                    if (auto_drive_imu(-1, 132,-85,angles.firstAngle)) {
                        reset_drive_encoders();
                        stage++;
                    }
                }
            ...
            case 8:
                ...
                if (auto_drive_imu(-0.5, 25,-170,angles.firstAngle)) {
                    intakeOut(1);
            ...
            case 12:
                ...
                if (position == 1) {
                    ...
                    if (auto_turn_imu(-75, angles.firstAngle)) {
                        intakeOut(0);
                        foundationServoLeft.setPosition(ConstantVariables.K_FOUNDATION_LEFT_UP);
                        foundationServoRight.setPosition(ConstantVariables.K_FOUNDATION_RIGHT_UP);
                        reset_drive_encoders();
                    ...
                    if (auto_turn_imu(-70, angles.firstAngle)) {
                        intakeOut(0);
                        foundationServoLeft.setPosition(ConstantVariables.K_FOUNDATION_LEFT_UP);
                        foundationServoRight.setPosition(ConstantVariables.K_FOUNDATION_RIGHT_UP);
                        reset_drive_encoders();
            ...
            case 13:
                ...
                if (position == 0) {
                    if (auto_drive_imu(1, 114, -80, angles.firstAngle)) {
                        reset_drive_encoders();
                        stage++;
                    }
                } else if (position == 1) {
                    if (auto_drive_imu(1, 101, -80, angles.firstAngle)) {
                        reset_drive_encoders();
                        stage++;
                    }
                } else if (position == 2) {
                    if (auto_drive_imu(1, 84, -80, angles.firstAngle)) {
                        reset_drive_encoders();
                        stage++;
                    }
                }
            ...
            case 15:
                //drive forward to pick up skystone
                if (auto_drive_imu(0.4,30, -25, angles.firstAngle)) {
                    intakeOut(0);
                    reset_drive_encoders();
                    stage++;
                }
            ...
            case 16:
                //back up to original spot
                if (auto_drive_imu(-1,20, -25, angles.firstAngle)) {
                    intake(0);
                    reset_drive_encoders();
                    stage++;
                }
            ...
            case 18:
                ...
                if (position == 0) {
                    if (auto_drive_imu(-1, 115,-85, angles.firstAngle)) {
                        intakeOut(1);
                        reset_drive_encoders();
                        timer.reset();
                        stage++;
                    ...
                    if (auto_drive_imu(-1, 85,-85, angles.firstAngle)) {
                        intakeOut(1);
                        reset_drive_encoders();
                        timer.reset();
                        stage++;
